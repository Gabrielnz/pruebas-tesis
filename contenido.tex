...
1 & Las opciones est\'{a}n agrupadas de tal forma que las opciones semejantes quedan juntas. &  &  &  \\ \hline

2 & Se utilizan solamente iconos que ayudan a los usuarios a reconocer una clase de elementos de forma inmediata. &  &  &  \\ \hline

3 & El \'{a}rea de navegaci\'{o}n principal est\'{a} situada en un lugar relevante, preferiblemente junto a la vista principal del software. &  &  &  \\ \hline

4 & No incluye m\'{u}ltiples \'{a}reas de navegaci\'{o}n para los mismos tipos de opciones. &  &  &  \\ \hline

5 & Puede habilitar b\'{u}squedas sencillas, con la posibilidad de b\'{u}squedas avanzadas. &  &  &  \\ \hline

6 & Se ofrece a los usuarios un acceso directo a tareas de alta prioridad en el software. &  &  &  \\ \hline
...
1 & Los estilos de fuente y otros formatos de texto, como los tama\~{n}os, los colores, etc., en el software, son sencillos. &  &  &  \\ \hline

2 & Los elementos m\'{a}s importantes de la vista principal son visibles <<en su totalidad>>, sin necesidad de realizar un desplazamiento.  &  &  &  \\ \hline

3 & Se utilizan pocos logotipos. &  &  &  \\ \hline

4 & Se utilizan las gr\'{a}ficas e im\'{a}genes para mostrar el contenido real y no s\'{o}lo para decorar el software. &  &  &  \\ \hline

5 & Se etiquetan las gr\'{a}ficas e im\'{a}genes al no quedar claras en el contexto que las acompa\~{n}a. &  &  &  \\ \hline

6 & Se muestran las gr\'{a}ficas e im\'{a}genes ajust\'{a}ndolas al tama\~{n}o adecuado para su visualizaci\'{o}n. &  &  &  \\ \hline

7 & La imagen del logotipo del software se muestra de forma est\'{a}tica. &  &  &  \\ \hline

8 & Se tienen pocas animaciones. &  &  &  \\ \hline

9 & Se evita utilizar im\'{a}genes de fondo para colocarles texto encima. &  &  &  \\ \hline

10 & Se mantiene una coherencia y uniformidad en las estructuras y colores de todas las vistas del software. &  &  &  \\ \hline

11 & La interfaz del software es limpia, sin causar ruido visual. &  &  &  \\ \hline

12 & Se hace un uso correcto del espacio visual de la interfaz del software. &  &  &  \\ \hline
